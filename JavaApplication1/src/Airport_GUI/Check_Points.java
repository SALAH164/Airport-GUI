 ...
 * @author xiiMody
 */
public class Check_Points extends javax.swing.JFrame {

    /**
     * Creates new form Check_Points
     */
    public Check_Points() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("New Check Point");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Check_Points.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Check_Points().setVisible(true);
            }
        });
    }
